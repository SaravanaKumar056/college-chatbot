...
def get_gemini_response(prompt):
    ...
    try:
        ...
        # Provide context to the model to improve its answers
        full_prompt = (
            "You are a helpful and friendly chatbot for Hindustan College of Arts and Science in Coimbatore, Tamil Nadu, India. "
            "Your knowledge base is primarily the `college_data.json` file. "
            "If the user's question isn't directly in your knowledge base, use your general knowledge to answer, "
            "but always maintain the persona of the college chatbot. Keep your answers concise and helpful. "
